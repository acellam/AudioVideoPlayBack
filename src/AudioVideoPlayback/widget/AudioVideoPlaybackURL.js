...
define([
    ...
    return declare('AudioVideoPlayback.widget.AudioVideoPlaybackURL', [_WidgetBase, _TemplatedMixin], {
...
require(['AudioVideoPlayback/widget/AudioVideoPlaybackURL'], function () {
    'use strict';
});